...
public class FrameworkTestsAddi {
    /*
        ...
        static com.sparta.owframework.frameworktests.FrameworkTests.Clouds clouds;
        ...
        class name{
            ...
            @DisplayName("MOCKING")
            void mockingTests (){
                com.sparta.owframework.frameworktests.FrameworkTests.Clouds mockCloud = Mockito.mock(com.sparta.owframework.frameworktests.FrameworkTests.Clouds.class);
                com.sparta.owframework.frameworktests.FrameworkTests.Coord mockCoord = Mockito.mock(com.sparta.owframework.frameworktests.FrameworkTests.Coord.class);
                Main mockMain = Mockito.mock(Main.class);
                com.sparta.owframework.frameworktests.FrameworkTests.Rain mockRain = Mockito.mock(com.sparta.owframework.frameworktests.FrameworkTests.Rain.class);
                com.sparta.owframework.frameworktests.FrameworkTests.Snow mockSnow = Mockito.mock(com.sparta.owframework.frameworktests.FrameworkTests.Snow.class);
